<?php    
$feature_post_cat_9 = get_theme_mod( 'molakat_feature_post_9', 0 );
  $feature_post_9 = new wp_query( array('cat' => $feature_post_cat_9, 'posts_per_page'=> 1, 'no_found_rows' => 1 , 'ignore_sticky_posts' => true)  );
  /* Start the Loop */

  $count = (int)0;
  while ( $feature_post_9->have_posts() ) : $feature_post_9->the_post(); 
  if ($count == 0) { ?>
...
<div class="p_fn">        
<?php    
  $feature_post_9x = new wp_query( array('cat' => $feature_post_cat_9, 'posts_per_page'=> 4, 'no_found_rows' => 1 , 'ignore_sticky_posts' => true)  );
  /* Start the Loop */

  $count = (int)0;
  while ( $feature_post_9x->have_posts() ) : $feature_post_9x->the_post(); 
  if ($count > 0) { ?>
