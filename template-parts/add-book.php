<?php    
$feature_post_cat_12 = get_theme_mod( 'molakat_feature_post_12', 0 ); 
$feature_post_12 = new wp_query( array('cat' => $feature_post_cat_12, 'posts_per_page'=> 6, 'no_found_rows' => 1 , 'ignore_sticky_posts' => true)  );
/* Start the Loop */
while ( $feature_post_12->have_posts() ) : $feature_post_12->the_post();?>
